...
@Service
public class ProductUserDetailService implements UserDetailsService {
    @Autowired
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        NykaaUser user = userRepository.findByMailId(username);
        if (user != null) {
            return new User(user.getMailId(), user.getPassword(), buildSimpleGrantedAuthorities(user.getRoles()));
        } else {
